...
if($dayofweek==0){
    if($hour>=12&&$hour<21){
        echo give_data($weekender.$snelling_stop);
    }
}
else if($dayofweek==6){
    if($hour>=10&&$hour<7){
...
//saturday
    ...
    echo give_data($princemilledge.$snelling_stop);
}
//weekdays and working hours
else if($hour>6&&$hour<19){
    echo give_data($healthsciences.$snelling_stop);
}
