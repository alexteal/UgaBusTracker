...
$memorialhall_stop = '2737275/pattern';
$tatecenter_stop = '2737276/pattern';
...
if($dayofweek==0){
    if($hour>=12&&$hour<21){
        echo give_data($weekender.$memorialhall_stop);
    }
}
else if($dayofweek==6){
    if($hour>=10&&$hour<7){
...
else if(($hour>6&&$hour<19)&&$dayofweek<=6){
    echo give_data($healthsciences.$memorialhall_stop);
}
//nights and saturday night
else if(($hour<3||$hour>=19)&&$dayofweek!=0){
    echo give_data($princemilledge.$tatecenter_stop);
}
else if($hour<7){
